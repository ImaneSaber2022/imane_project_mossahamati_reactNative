...
import imgeyees from '../../../../../assests/images/imgeyees.png';
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View
            ...
            <View>
              <Text
                style={[
                  styles.signin_annul,
                  {marginLeft: 50, color: '#464E5F', marginTop: 10},
                ]}>
                intitule
              </Text>
            </View>
          ...
          <View
            ...
            <View style={{height: 35, width: '70%', justifyContent: 'center'}}>
              <Select placeholder="listes Modeles"></Select>
            </View>
          </View>
