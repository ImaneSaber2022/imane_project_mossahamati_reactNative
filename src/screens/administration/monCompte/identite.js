          ...
          <View
            ...
            <View>
              <View
                ...
                <Image source={photo} style={styles.img} resizeMode="contain" />
              </View>
            </View>
          </View>
          ...
          <View
            ...
            <View>
              <Text
                style={[
                  styles.signin_annul,
                  {marginLeft: 15, color: '#464E5F', marginTop: 10},
                ]}>
                Adress mail
              </Text>
            </View>
            <View style={styles.action}>
              <TextInput placeholder=" Adress mail" style={{width: 200}} />
            </View>
          </View>
          <View
            style={{
            ...
            <View style={styles.action}>
              <TextInput placeholder="0645748699" style={{width: 200}} />
            </View>
          </View>
          <View
            style={{
            ...
            <View>
              <Text
                style={[
                  styles.signin_annul,
                  {marginLeft: 27, color: '#464E5F', marginTop: 10},
                ]}>
                Adresse
              </Text>
            </View>
            <View style={styles.action}>
              <TextInput placeholder="Adresse ligne 1" style={{width: 200}} />
            </View>
          </View>
          <View
            style={{
